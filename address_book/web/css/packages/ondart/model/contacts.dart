...
class Contact extends ConceptEntity<Contact> {
  ...
  String get first_name => _first_name; /*block to get the value of first_name into string*/
  ...
  String get last_name => _last_name; /*block to get the value of last_name into string*/
  ...
  String get cell_number => _cell_number; /*block to get the value of cell_number into string*/
